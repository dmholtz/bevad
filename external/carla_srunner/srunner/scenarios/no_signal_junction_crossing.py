...
class NoSignalJunctionCrossing(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        _ego_vehicle_max_velocity = get_value_parameter(config, 'ego_vehicle_max_velocity', float, 20) # [km/h]
        _ego_vehicle_driven_distance = 105 # [m]

        # other vehicle
        _other_actor_max_brake = get_value_parameter(config, 'other_actor_max_brake', float, 1.0) # [m/s^2]
        _other_actor_target_velocity = get_value_parameter(config, 'other_actor_target_velocity', float, 15) # [km/h]
