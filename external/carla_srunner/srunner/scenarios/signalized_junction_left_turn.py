...
class JunctionLeftTurn(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self._green_light_delay = get_value_parameter(config, 'green_light_delay', float, 5) # Wait before the ego's lane traffic light turns green [m]
        self._flow_tl_dict = {}
        self._init_tl_dict = {}
    ...
    def _initialize_actors(self, config):
        ...
        for tl in tls:
            if tl.id == ego_tl.id:
                ...
                # Opposite flow always has green light
                self._flow_tl_dict[tl] = carla.TrafficLightState.Green
...
class NonSignalizedJunctionLeftTurnStrict(NonSignalizedJunctionLeftTurn):
    pass