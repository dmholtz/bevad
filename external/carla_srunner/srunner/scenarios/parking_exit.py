...
class ParkingExit(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, debug_mode=False, criteria_enable=True,
        ...
        self._front_vehicle_distance = get_value_parameter(config, 'front_vehicle_distance', float, 20) # [m]
        self._behind_vehicle_distance = get_value_parameter(config, 'behind_vehicle_distance', float, 10) # [m]
