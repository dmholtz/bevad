...
class ConstructionObstacle(BasicScenario):
    ...
    def _initialize_actors(self, config):
        ...
        # ConstructionObstacle and ConstructionObstacleTwoWays are ocasionally wrongly labeled, hence distinguish them here
        ...
        CarlaDataProvider.active_scenarios.append((scenario_name, [traffic_warning, last_cone, self._direction, False, 1e9, 1e9, False]))
