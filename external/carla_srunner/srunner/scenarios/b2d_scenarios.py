"""Additional scenarios from Bench2Drive."""
...
from srunner.tools.scenario_helper import get_closest_traffic_light, get_junction_topology, generate_target_waypoint, filter_junction_wp_direction, get_same_dir_lanes
