...
class CarlaDataProvider(object):  # pylint: disable=too-many-public-methods
    ...
    """
    # Save which type of scenario is currently running. This information is required by PDM-lite and cannot be detected from outside.
    active_scenarios = []

    # Save which actors have open doors
    open_doors = defaultdict(lambda: False) # dict[int, bool], maps actor ids to whether door is open
    ...
    def cleanup():
        ...
        CarlaDataProvider.open_doors.clear()
