...
class GlobalConfig:
    ...
    def __init__(self):
        ...
        # IDM minimum distance for red lights
        self.idm_red_light_minimum_distance_europe = 9.0  # 3 additional meters due to different light box placement
        ...
        # Path where speed limit files can be found
        self.speed_limits_path = "artifacts/speed_limits"
        # -----------------------------------------------------------------------------
        ...
        self.slower_factor = (
            0.8  # Factor by which the target speed will be reduced during inference if slower is active
        )
